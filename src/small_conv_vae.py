...
class ConvEncoder(nn.Module):
    def __init__(self, latent_dim: int) -> None:
        ...
        # Updated feature size: 128 * 5 * 9
        self.fc_mean = nn.Linear(128 * 5 * 9, latent_dim)
        self.fc_log_var = nn.Linear(128 * 5 * 9, latent_dim)
...
class ConvDecoder(nn.Module):
    def __init__(self, latent_dim: int, output_shape: tuple) -> None:
        super().__init__()
        self.latent_to_feature = nn.Linear(latent_dim, 128 * 5 * 9)
