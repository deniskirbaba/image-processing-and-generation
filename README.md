...
1. Введение
    1.1 Введение в задачи компьютерного зрения
...
2. Автоэнкодеры и генеративно-состязательные сети, image-to-image translation
    2.1 Введение в задачи генерации. Автоэнкодеры
    2.2 Генеративно-состязательные сети
    2.3 Задачи image-to-image translation
...
Когда залили выполненное ДЗ на git, поставьте в [таблице](https://docs.google.com/spreadsheets/d/1izp-aQsaxlT9wa6xmshuegMwX0lHmseo38x3cmUQyGE/edit#gid=0) напротив своей фамилии в соответствующей колонке '+'. После проверки вместо него появятся баллы.

| № | ДЗ                                                                                         | Кол-во баллов | Дедлайн    |
|---|--------------------------------------------------------------------------------------------|---------------|------------|
| 1 | решение задачи компьютерного зрения                                                        | 25            | 23.12.2024 |
| 2 | решение задачи anomaly detection                                                           | 25            | 23.12.2024 |
| 3 | решение задачи компьютерного зрения с использованием unsupervised/self-supervised learning | 30            | 23.12.2024 |
|   | доклад в группе                                                                            | 10            | 23.12.2024 |
